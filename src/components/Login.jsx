      ...
      try {
        ...
        if (userRole) {
          ...
          if (userRole === 'Instructor') {
            window.location.href = '/signbrige/Instructors_dashboard';
          } else if (userRole === 'Learner') {
            window.location.href = '/signbrige/Learners_dashboard';
          } else {
            window.location.href = '/signbrige/signup'; // fallback
          }
        }
      } catch (error) {
        console.error('Error getting user role:', error);
        // Fallback to generic dashboard if role fetch fails
        window.location.href = '/signbrige/signup';
      }
    }
  });
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Or{' '}
          <a href="/signbrige/signup" className="font-medium text-blue-600 hover:text-blue-500">
