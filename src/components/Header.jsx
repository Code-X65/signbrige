...
const Header = () => {
  ...
  const getDashboardRoute = () => {
    if (userRole === 'Instructor') {
      return '/signbrige/Instructors_dashboard';
    } else {
      return '/signbrige/Learners_dashboard';
    }
  ...
  const profileMenuItems = [
    ...
    },
    {
      name: "Profile",
      icon: UserCircle,
      href: "/signbrige/profile",
      description: "Manage your profile"
    },
    {
      name: "Settings",
      icon: Settings,
      href: "/signbrige/settings",
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      window.location.href = '/signbrige';
      // Alternative: use your router's navigation
      // navigate('/');
