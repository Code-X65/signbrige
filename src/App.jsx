...
const PublicRoute = ({ children, isAuthenticated, isLoading }) => {
  ...
  return !isAuthenticated ? children : <Navigate to="/signbrige/dashboard" replace />;
};
    ...
    <>
      <Router>
        ...
        <Routes>
          ...
          <Route 
            path='/signbrige/Instructors_dashboard/*' 
            element={
          ...
          />
          <Route 
            path='/signbrige/Learners_dashboard/*' 
            element={
              <ProtectedRoute isAuthenticated={isAuthenticated} isLoading={isLoading}>
                <Learners_Dashboard />
              </ProtectedRoute>
